...
const Footer = () => (
  <footer className="relative">
    ...
    <Image 
                ...
                layout="fill"
                objectFit="cover"
                priority // This helps load the image faster as it’s part of the layout
            />
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
        ...
        <div className="space-y-4">
          <Image
            src="/logo-white.png"
            alt="Bean Scene Logo"
            width={48} // Adjust based on actual logo size
            height={48} // Adjust based on actual logo size
          />
        ...
        <div>
          ...
          <ul className="space-y-2">
            <li>
              <a
                href="#"
                className="text-gray-300 hover:text-customYellow transition-colors"
              >
                About Us
              </a>
            </li>
